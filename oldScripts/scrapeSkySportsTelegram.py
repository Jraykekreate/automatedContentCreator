#!/usr/bin/env python3
"""
telegram_engagement_telethon_fixed.py

Fetch messages from a Telegram channel (last N days), compute an EngagementScore,
and print the top-N messages.

Install:
    pip install telethon

Before running:
    1. Create a Telegram app at https://my.telegram.org/apps to get API_ID and API_HASH
    2. Export env vars (example for bash; NO spaces around '='!):
       export TELEGRAM_API_ID=25842192
       export TELEGRAM_API_HASH="b4149f4f29d98ba2f760f66f3142bc1a"

Usage example:
    python telegram_engagement_telethon_fixed.py --channel Sky_sports_football_updates --days 3 --top 20
"""
...
async def scrape_channel(
    ...
    client = TelegramClient(os.getenv("TELEGRAM_SESSION", "telegram_scraper_session"), api_id, api_hash)
    await client.start()
    ...
    try:
        ...
        print("Example export (bash):")
        print('  export TELEGRAM_API_ID=25842192')
        print('  export TELEGRAM_API_HASH="b4149f4f29d98ba2f760f66f3142bc1a"')
